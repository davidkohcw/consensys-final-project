...
//@ts-ignore
InjectedWeb3Connector.handleNetworkChanged = (networkId: string | number) => {
    ...
    //@ts-ignore
    InjectedWeb3Connector.emitUpdate({ chainId: networkId, provider: window.ethereum })
}
